  ...
  return (
    <div className="min-h-screen bg-zinc-50">
      <div className="max-w-7xl mx-auto p-8 animate-fade-in">
        <h1 className="text-4xl font-bold mb-8 text-zinc-900">면접 결과</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-8 space-y-6">
              <div className="p-6 bg-white rounded-2xl border border-zinc-200 shadow-sm">
                <h2 className="text-xl font-bold mb-4 text-zinc-900">종합 평가</h2>

                {/* 종합 피드백 */}
                <div>
                  <h3 className="text-sm font-semibold text-zinc-600 uppercase mb-3">종합 피드백</h3>
              ...
              <div className="flex gap-4">
                <button
                  ...
                  className="flex-1 px-4 py-3 bg-white hover:bg-zinc-50 text-zinc-900 border border-zinc-200 rounded-lg transition-all shadow-sm"
                >
                  홈으로
                </button>
                <button
                  onClick={() => window.print()}
                  className="flex-1 px-4 py-3 bg-zinc-900 hover:bg-zinc-800 text-white rounded-lg transition-all shadow-sm active:scale-95 font-medium"
                >
                  결과 출력
                </button>
              </div>
          ...
          <div className="lg:col-span-2 space-y-4">
            <h2 className="text-2xl font-bold mb-4 text-zinc-900">질문별 상세 피드백</h2>
